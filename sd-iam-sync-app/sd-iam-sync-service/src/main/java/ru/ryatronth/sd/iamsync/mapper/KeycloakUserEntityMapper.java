...
public abstract class KeycloakUserEntityMapper {
  ...
  public abstract void updateEntityFromKeycloak(KeycloakUserRepresentation rep,
                                                @MappingTarget IamUserEntity entity);

  @AfterMapping
  protected void fillAttributesAndGroups(KeycloakUserRepresentation rep,
                                         @MappingTarget IamUserEntity entity) {
